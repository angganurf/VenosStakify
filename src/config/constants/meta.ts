...
export const DEFAULT_META: PageMeta = {
  title: 'Venos Stakify',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Venos Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Venos Project), NFTs, and more, on a platform you can trust.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for VenosStakify exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for VenosStakify exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for VenosStakify exchanges.' },
    ...
    defaultTitleSuffix: t('Venos Stakify'),
  }
}
