...
describe('utils', () => {
  describe('#getBscScanLink', () => {
    it('correct for tx', () => {
      expect(getBscScanLink('abc', 'transaction', ChainId.BSC)).toEqual('https://opbnbscan.com/tx/abc')
    })
    it('correct for token', () => {
      expect(getBscScanLink('abc', 'token', ChainId.BSC)).toEqual('https://opbnbscan.com/token/abc')
    })
    it('correct for address', () => {
      expect(getBscScanLink('abc', 'address', ChainId.BSC)).toEqual('https://opbnbscan.com/address/abc')
    })
    it('enum', () => {
