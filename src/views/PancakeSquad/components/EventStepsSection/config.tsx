  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Venos Stakify Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/swap?outputCurrency=0xadEFbbac7501f4Df8aDC7288c2FA86d36A3E9ebC"
            target="_blank"
            width="100%"
          >
            {t('Buy VENOS')}
