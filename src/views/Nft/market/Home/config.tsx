  ...
  return [
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.venosproject.com/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by Venos Stakify from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
