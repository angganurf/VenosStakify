...
export const SwitchUnits: React.FC = () => {
  const CAKE_PRICE = 69;
  const [editingUnit, setEditingUnit] = useState<"VENOS" | "USD">("VENOS");
  const conversionUnit = editingUnit === "VENOS" ? "USD" : "VENOS";
  ...
  const switchEditingUnits = () => {
    const editingUnitAfterChange = editingUnit === "VENOS" ? "USD" : "VENOS";
